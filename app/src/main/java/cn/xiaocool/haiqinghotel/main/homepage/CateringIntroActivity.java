...
public class CateringIntroActivity extends Activity implements View.OnClickListener {
    private String cateringId, cateringName, cateringPrice, cateringOprice, cateringUnit, cateringDesc;
                    ...
                    try {
                        ...
                        if (status.equals("success")) {
                            ...
                            simpleAdapter = new SimpleAdapter(CateringIntroActivity.this, arraylist, R.layout.catering_list_item,
                                    new String[]{"name", "unit", "price"},
                                    new int[]{R.id.tv_catering_name, R.id.tv_catering_unit, R.id.tv_catering_price});
