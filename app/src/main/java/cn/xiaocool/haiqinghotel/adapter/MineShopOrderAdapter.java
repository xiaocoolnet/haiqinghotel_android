 ...
 */
public class MineShopOrderAdapter extends BaseAdapter {
    private LayoutInflater layoutInflater;
    private ArrayList<HashMap<String, String>> arrayList;
    private DisplayImageOptions displayImageOptions;
    private ImageLoader imageLoader = ImageLoader.getInstance();

    public MineShopOrderAdapter(Context context, ArrayList<HashMap<String, String>> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = layoutInflater.inflate(R.layout.mine_shop_order_item, null);
        //初始化控件
